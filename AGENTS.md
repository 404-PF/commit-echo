...
│   └── completion.ts     # Generate shell completion scripts (bash, zsh, fish, powershell)
├── providers/
...
| `commit-echo completion` | Generate shell completion scripts (bash, zsh, fish, powershell) |
